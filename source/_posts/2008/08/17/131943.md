...
とりあえず、<a href="http://www.nishimiyahara.net/">過去のブログ</a>に対してはプログラムが入っているディレクトリへのアクセスを禁止しました。
<a href="http://www.nishimiyahara.net/robots.txt">http://blog.nqou.net/robots.txt</a>
