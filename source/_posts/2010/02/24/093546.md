...
<p>SEE ALSO</p>
<ul>
<li><a href="http://search.cpan.org/search?query=authentication&mode=all" target="_blank">CPANでauthenticationを検索した結果</a></li>
</ul>
</div>
...
&#133;これは楽だ。
結構簡単にユーザー登録はできた。
本当は、ハッシュの作成に<a href="http://search.cpan.org/dist/Crypt-SaltedHash/" target="_blank">Crypt::SaltedHash</a>を使いたかった。
